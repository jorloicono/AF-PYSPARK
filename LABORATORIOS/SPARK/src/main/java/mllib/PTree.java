...
public class PTree {
    ...
    public static void main(String[] args) {
        ...
        SparkSession spark = SparkSession
                ...
                .getOrCreate();
        Dataset<Row> rowDS = spark.read().csv("C:\\Users\\Usuario\\Desktop\\SPARK\\data\\mllib\\loan_train.csv");
        ...
        JavaRDD<String> rowRdd =
                spark.sparkContext().textFile("C:\\Users\\Usuario\\Desktop\\SPARK\\data\\mllib\\loan_train.csv", 1).toJavaRDD();
